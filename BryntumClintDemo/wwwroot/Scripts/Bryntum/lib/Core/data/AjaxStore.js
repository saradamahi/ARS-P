...
export default class AjaxStore extends Store {
     ...
     * @event beforeRequest
     * @param {Core.data.Store} source This Store
     * @param {Object} params An object containing key/value pairs that are passed on the requests query string
    ...
    static get defaultConfig() {
        return {
            ...
            /**
             * An object containing key/value pairs that are passed on the requests query string. You can set the params dynamically in a {@link #event-beforeRequest} listener.
             * @config {Object}
             * @default
             * @category Remote
             */
