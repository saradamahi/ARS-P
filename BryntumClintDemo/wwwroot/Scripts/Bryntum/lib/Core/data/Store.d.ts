...
export default class Store extends Events(Base) {
    ...
    forEach(fn : (model : InstanceType<this[ 'modelClass' ]>, index? : number) => void, thisObj? : any, includeFilteredOutRecords? : boolean) : void

    traverse(fn : (model : InstanceType<this[ 'modelClass' ]>) => void, topNode? : Partial<InstanceType<this[ 'modelClass' ]>> | boolean, skipRoot? : boolean, includeFilteredOutRecords? : boolean) : void
