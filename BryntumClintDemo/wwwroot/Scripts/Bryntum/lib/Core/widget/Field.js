...
export default class Field extends Widget.mixin(Badge) {
    ...
    doDestroy() {
        const
            me           = this,
            { triggers } = me,
            errorTip     = me.isPainted && me.errorTip;
    ...
    static getSharedErrorTooltip(rootElement) {
        let sharedErrorTooltip = rootElement.bryntum?.errorTooltip;

        if (!sharedErrorTooltip) {
