...
export default class Combo extends PickerField {
    ...
    /**
     * A {@link Core.util.Collection Collection} which holds the currently selected records
    ...
    changePicker(picker, oldPicker) {
        ...
        picker = List.reconfigure(oldPicker, picker ? List.mergeConfigs({
            ...
            cls         : me.listCls,
            itemTpl     : me.listItemTpl || (item => StringHelper.encodeHtml(item[me.displayField])),
