...
export default class Tooltip extends Popup {
    ...
    static getSharedTooltip(rootElement) {
        let sharedTooltip = rootElement.bryntum?.tooltip;

        if (!sharedTooltip) {
            const nodeData   = rootElement.bryntum = rootElement.bryntum || {};
            nodeData.tooltip = true; // Avoid infinite loop as the Tooltip gets created with rootElement too
            ...
            nodeData.tooltip = sharedTooltip;
        }
