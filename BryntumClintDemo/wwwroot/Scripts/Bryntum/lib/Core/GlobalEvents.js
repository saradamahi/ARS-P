        ...
        setupFocusListeners(element = document, EventHelper, detach = false) {
            const listeners = {
                ...
                focusin(focusin) {
                    ...
                    GlobalEvents.Widget.resetFloatRootScroll();
                    ...
                    if (commonAncestor && focusin.target === commonAncestor.element) {
                        ...
                        if (DomHelper.getActiveElement(commonAncestor) === toElement && commonAncestor.focusElement && commonAncestor.focusElement !== commonAncestor.element) {
                    ...
                    const commonAncestorEl = DomHelper.getCommonAncestor(fromElement && fromElement.nodeType === 1 ? fromElement : null, toElement) || toElement.parentNode;
