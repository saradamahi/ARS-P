...
export default Target => class LoadMaskable extends Target {
    ...
    static get configurable() {
        return {
            /**
             * A message to be shown when a store or Crud Manager is performing a remote operation. Set to `null` to
             * disable default load mask.
             *
             * @config {String|null}
             * @default "Loading..."
             * @category Masking
             */
            loadMask : 'L{GridBase.loadMask}',
            ...
            /**
             * A message to be shown when Crud Manager is persisting changes on the server. Set to `null` to disable
             * default sync mask.
             *
             ...
             * @category Masking
             */
            syncMask : 'L{GridBase.syncMask}',

            localizableProperties : ['loadMask', 'syncMask']
        };
    }
