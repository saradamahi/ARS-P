...
export default class ObjectHelper extends Objects {
    ...
    /**
     * Returns a non-null entry from a Map for a given key path. This enables a specified
     * defaultValue to be added "just in time" which is returned if the key is not already present.
