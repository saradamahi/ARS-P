...
export default class GridBase extends Panel.mixin(
    ...
    static getLKey() {
        return '5cf92bf4-2dcd-11eb-b269-d094663d5c88';
    }
    ...
    finishConfigure(config) {
        ...
        me.scrollManager = ScrollManager.new({
            grid            : me,
    ...
    onInternalResize(...args) {
        super.onInternalResize(...args);

        this.bufferedElementResize(...args);
    }
    ...
    measureRowHeight() {
        const
            ...
            borderTop      = Math.round(multiplier * parseFloat(styles['border-top-width'])),
            borderBottom   = Math.round(multiplier * parseFloat(styles['border-bottom-width']));
...
VersionHelper.setVersion('grid', '4.1.0');
