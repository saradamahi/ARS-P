...
export default class SubGrid extends Widget {
    ...
    changeHeader() {
        ...
        barConfig.id = this.id + '-header';
        return new this.headerClass(barConfig);
    }

    changeFooter() {
        const { barConfig } = this;

        barConfig.id = this.id + '-footer';
        return new this.footerClass(barConfig);
    }
    ...
    resizeColumnsToFitContent() {
        ...
        this.columns.bottomColumns.forEach(column => {
