...
(_window$examples = window.examples) === null || _window$examples === void 0 ? void 0 : _window$examples.forEach(function (e) {
  e.rootFolder = '../examples-scheduler/';
}); // The file should be included after examples.js from Scheduler

window.examples = (_ref = []).concat.apply(_ref, [[{
  folder: 'bigdataset',
  group: 'Pro',
  ...
  group: 'Integration/Pro',
  title: 'Angular Pro Resource Histogram demo',
  version: 'Angular 10',
  build: true
}, {
  folder: 'frameworks/react/javascript/resource-histogram',
  group: 'Integration/Pro',
  title: 'React Pro Resource Histogram demo',
  version: 'React 16.13',
  build: true
}, {
  folder: 'frameworks/react/javascript/timeline',
  group: 'Integration/Pro',
  title: 'React Pro Timeline demo',
  version: 'React 17',
  since: '4.1',
  build: true
}, {
  ...
  group: 'Integration/Pro',
  title: 'Vue Pro Resource Histogram demo',
  version: 'Vue 2.6',
  build: true
}, {
  folder: 'frameworks/vue/javascript/vue-renderer',
  group: 'Integration/Pro',
  title: 'Vue Pro Cell Renderer demo',
  version: 'Vue 2.6',
  build: true,
  since: '4.1.0'
}, {
  ...
  group: 'Integration/Pro',
  title: 'Vue 3 Pro Resource Histogram demo',
  version: 'Vue 3.0',
  build: true,
  since: '4.1'
}]].concat(_toConsumableArray(window.examples))); // Filter demos by browser
