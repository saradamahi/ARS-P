...
class ExamplesApp {
    constructor() {
        const
            ...
            storageName     = (name) => `bryntum-${product.name}-demo-${name}`,
        ...
        document.getElementById('title').innerHTML = `${product.fullName} ${version}`;
        ...
        const toolbar = new Toolbar({
            ...
            items : {
                ...
                upgradeButton : {
                    ...
                    text : 'Upgrade guide',
                    icon : 'b-fa-book',
                    href : me.isOnline ? `/docs/${product.onlineDocsId}#upgrade-guide` : '../docs#upgrade-guide'
                },
                docsButton : {
                    id   : 'docs-button',
                    type : 'button',
                    text : 'Documentation',
                    icon : 'b-fa-book-open',
                    href : me.isOnline ? `/docs/${product.onlineDocsId}` : '../docs'
                },
