...
var _bryntum$schedulerpro = bryntum.schedulerpro,
    Store = _bryntum$schedulerpro.Store,
    ...
    DomSync = _bryntum$schedulerpro.DomSync,
    EventHelper = _bryntum$schedulerpro.EventHelper,
    Toolbar = _bryntum$schedulerpro.Toolbar,
...
var ExamplesApp = /*#__PURE__*/function () {
  function ExamplesApp() {
    ...
    var me = this,
      ...
      return "bryntum-".concat(product.name, "-demo-").concat(name);
    },
    ...
    document.getElementById('title').innerHTML = "".concat(product.fullName, " ").concat(version);
    GlobalEvents.on({
    ...
    var toolbar = new Toolbar({
      ...
      items: {
        ...
        upgradeButton: {
          ...
          text: 'Upgrade guide',
          icon: 'b-fa-book',
          href: me.isOnline ? "/docs/".concat(product.onlineDocsId, "#upgrade-guide") : '../docs#upgrade-guide'
        },
        docsButton: {
          id: 'docs-button',
          type: 'button',
          text: 'Documentation',
          icon: 'b-fa-book-open',
          href: me.isOnline ? "/docs/".concat(product.onlineDocsId) : '../docs'
        },
